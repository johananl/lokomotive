...
// // Load loads the HCL body b into the Config struct.
// func (c *Config) Load(b *hcl.Body, ctx *hcl.EvalContext) hcl.Diagnostics {
// 	if b == nil {
// 		return hcl.Diagnostics{}
// 	}

// 	if diags := gohcl.DecodeBody(*b, ctx, c); len(diags) != 0 {
// 		return diags
// 	}
